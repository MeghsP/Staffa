...
export default class AppProvider extends React.Component {
  ...
  */
  ...
  handleFirstConnectivityChange = (connectionInfo) => {
    console.log('handleFirstConnectivityChange' + connectionInfo.type + ', effectiveType: ' + connectionInfo.effectiveType);
  }
  ...
  listenNotificationOpen() {
    ...
    this.notificationAppAlreadyOpen = firebase.notifications().onNotificationOpened((notificationOpen) => {
      if (notificationOpen) {
        console.log("notificationAppAlreadyOpen : " + notificationOpen.notification.data);
        console.log("notificationAppAlreadyOpen : " + JSON.stringify(notificationOpen.notification.data));
    ...
    this.notificationOpenApp = firebase.notifications().getInitialNotification().then((notificationOpen) => {
      if (notificationOpen) {
        console.log('notificationOpenApp notificationOpen -->', notificationOpen);
        console.log("notificationOpenApp : " + notificationOpen.notification.data);
        console.log("notificationOpenApp : " + JSON.stringify(notificationOpen.notification.data));
        var data = notificationOpen.notification.data;
        if (data.type) {
          this.setState({openFromNotification:true});
          this.setState({notificationData:data});
